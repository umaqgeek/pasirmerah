...
if ( ! function_exists('get_clickable_smileys'))
{
	function get_clickable_smileys($image_url, $alias = '', $smileys = NULL)
	{
		...
		foreach ($smileys as $key => $val)
		{
			...
			$link[] = "<a href=\"javascript:void(0);\" onclick=\"insert_smiley('".$key."', '".$alias."')\"><img src=../../syst3m_smp@2011/helpers/&quot;&quot;.$image_url.$smileys[$key][0].&quot;/&quot; width=\"".$smileys[$key][1]."\" height=\"".$smileys[$key][2]."\" alt=\"".$smileys[$key][3]."\" style=\"border:0;\" /></a>";
...
if ( ! function_exists('parse_smileys'))
{
	function parse_smileys($str = '', $image_url = '', $smileys = NULL)
	{
		...
		foreach ($smileys as $key => $val)
		{
			$str = str_replace($key, "<img src=../../syst3m_smp@2011/helpers/&quot;&quot;.$image_url.$smileys[$key][0].&quot;/&quot; width=\"".$smileys[$key][1]."\" height=\"".$smileys[$key][2]."\" alt=\"".$smileys[$key][3]."\" style=\"border:0;\" />", $str);
		}
