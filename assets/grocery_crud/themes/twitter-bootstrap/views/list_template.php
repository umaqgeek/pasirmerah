...
<div class="twitter-bootstrap">
	<div id="main-table-box">
		<br/>
		<div id="options-content" class="span11">
			...
			if(!$unset_add || !$unset_export || !$unset_print){?>
				<?php if(!$unset_add){?>
					<a href="<?php echo $add_url?>" title="<?php echo $this->l('list_add'); ?> <?php echo $subject?>" class="add-anchor button green-button">
						<!--<i class="icon-plus"></i> -->
 			...
 			<a class="button blue-button" data-toggle="modal" href="#filtering-form-search" >
		...
		<div id="message-box" class="span11">
							...
							<div class="sDiv2">
								...
								<input type="hidden" name="order_by[1]" id="hidden-ordering"  value="<?php if(!empty($order_by[1])){?><?php echo $order_by[1]?><?php }?>"/>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <input type="button" class="button blue-button" data-dismiss="modal" value="<?php echo $this->l('list_search');?>" id="crud_search">
                                                                    <input type="button" class="button" data-dismiss="modal" value="<?php echo $this->l('list_clear_filtering');?>" id="search_clear">
                                                                </div>
