...
<div class="twitter-bootstrap crud-form">
	...
	<h3 class="span12" align="right"><?php echo $this->l('form_edit'); ?> <?php echo $subject?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </h3> </br></br></br></br>
	...
	<div class="col-md-8">
		...
		echo form_open( $update_url, 'method="post" id="crudForm" class="form-div span12" autocomplete="off" enctype="multipart/form-data"');
			...
			<input type="button" value="<?php echo $this->l('form_update_changes'); ?>" class="button green-button submit-form"/>
			<?php 	if(!$this->unset_back_to_list) { ?>
				<input type="button" value="<?php echo $this->l('form_update_and_go_back'); ?>" id="save-and-go-back-button" class="button blue-button"/>
				<input type="button" value="<?php echo $this->l('form_cancel'); ?>" data-target-url="<?php echo $list_url?>" class="button return-to-list" />
			<?php 	} ?>
