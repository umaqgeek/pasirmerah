///#source 1 1 /assets/js/jquery.touchSwipe.min.js
...
///#source 1 1 /assets/js/jBox.js
// Variables
var jBoxContainer = $(".jbox-container");
var jBoxContainerImg = $(".jbox-container img");
var altTextBox = $(".jbox-container .img-alt-text");
var buttonPrev = $(".jbox-container #prev");
var buttonNext = $(".jbox-container #next");
var buttonClose = $(".jbox-container #close");
var buttons = $(".jbox-container #next, .jbox-container #prev, .jbox-container #close");
...
function disableButton(direction) {
    if (direction == "prev") {
        buttonPrev.addClass("hidden-btn");
    }

    if(direction == "next"){
        buttonNext.addClass("hidden-btn");
    }
}
...
function enableButton(direction) {
    ...
    if (direction == "prev") {
        buttonPrev.removeClass("hidden-btn");
    }

    if (direction == "next") {
        buttonNext.removeClass("hidden-btn");
    }
}
