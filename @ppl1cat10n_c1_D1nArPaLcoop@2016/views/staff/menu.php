      ...
      <div class="row">
       <!-- <div class="col-sm-3 col-md-2 sidebar"> -->
         ...
         <!-- <ul class="nav nav-sidebar"> -->
          ...
          <li class="nav-parent" ><a href="<?=site_url('staff/newMenu/overview/06')?>" style="color:#fff;";>Overview</a></li>

          <li class="nav-parent" ><a href="<?=site_url('staff/newMenu/vault/015')?>" style="color:#fff;";>Vault</a></li>

          <li class="nav-parent" ><a href="<?=site_url('staff/newMenu/transaction/09')?>" style="color:#fff;">Transactions</a></li>

           <!--<li class="nav-parent" ><a href="<?=site_url('staff/transactions/transactionSummary/y5')?>" style="color:#fff;">Accounting</a></li>-->
           <li class="nav-parent" ><a href="<?=site_url('staff/transactions/transSum1/y51')?>" style="color:#fff;">Accounting</a></li>
