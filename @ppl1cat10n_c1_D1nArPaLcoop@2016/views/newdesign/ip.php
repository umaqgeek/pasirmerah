...
<head>
    ...
    <link href="<?php echo base_url();?>assets/csss/mai sn.css" rel="stylesheet">
    ...
    <![endif]       
    <link rel="shortcut icon" href="assets/assets/imagesss/ico/favicon.ico">-->
    <link rel="apple-touch-icon-precomposed" sizes="144x144" href="<?php echo base_url();?>assets/assets/imagess/ico/apple-touch-icon-144-precomposed.png">
    <link rel="apple-touch-icon-precomposed" sizes="114x114" href="<?php echo base_url();?>assets/assets/imagess/ico/apple-touch-icon-114-precomposed.png">
    <link rel="apple-touch-icon-precomposed" sizes="72x72" href="<?php echo base_url();?>assets/assets/imagess/ico/apple-touch-icon-72-precomposed.png">
    <link rel="apple-touch-icon-precomposed" href="<?php echo base_url();?>assets/assets/imagesss/ico/apple-touch-icon-57-precomposed.png">
    ...
    <section id="partners">
        <div class="container">
            <div class="section-header">
			    <BR><BR>
                <h2 class="section-title text-center wow fadeInDown">Intellectual Property</h2>
            ...
            <div class="row">
                <div class="col-sm-6 wow fadeInLeft">
                    <img class="img-responsive" src="<?php echo base_url(); ?>assets/imagess/document/patent.jpg" height="400px" width="400px" alt="">
                </div>
                ...
                <div class="col-sm-6">
                    ...
                    <div class="media service-box wow fadeInRight">
                        ...
                        <div class="media-body">
                            <h4 class="media-heading">The Patent</h4>
                            <p class="text-justify wow FadeInDown">The certificate of our patent, some of the information remain hidden for security purpose. If you want to know more please email to security@dinarpal.com</p>
                        </div>
                    </div>
        ...
        <div class="container">
            ...
            <div class="col-sm-6">
                ...
                <div class="media service-box wow fadeInRight">
                    ...
                    <div class="media-body">
                        <h4 class="media-heading">The Copyright</h4>
                        <p class="text-justify wow FadeInDown">The certificate of our copyright, some of the information remain hidden for security purpose. If you want to know more please email to security@dinarpal.com</p>
                    </div>
                </div>
            ...
            <div class="col-sm-6 wow fadeInLeft">
                <img class="img-responsive" src="<?php echo base_url(); ?>assets/imagess/document/copyright.jpg" height="400px" width="400px" alt="">
            </div>		
...
<div class="divider"></div>
    ...
    <section id="partners">
        <div class="container">
            <div class="row">
                <div class="col-sm-6 wow fadeInLeft">
                    <img class="img-responsive" src="<?php echo base_url(); ?>assets/imagess/document/trademark.jpg"  height="400px" width="400px" alt="">
                </div>
                ...
                <div class="col-sm-6">
                    ...
                    <div class="media service-box wow fadeInRight">
                        ...
                        <h4 class="media-heading">The Trademark</h4>
                        <p class="text-justify wow FadeInDown">The certificate of our trademark. If you want to know more please email to security@dinarpal.com</p>
                    </div>
