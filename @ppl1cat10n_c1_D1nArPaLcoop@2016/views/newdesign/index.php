            ...
            <nav class="navbar navbar-inverse" role="banner">
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="index-2.html"><img src="<?php echo base_url(); ?>assets/imagescoop/logo.png" alt="logo"></a>
                    </div>
                    <div class="collapse navbar-collapse navbar-right">
                        <ul class="nav navbar-nav">
                            ...
                            <li><a href="<?= site_url('version3/login');?>">Portfolio</a></li>
                            <li class="dropdown">
                            ...
                            <li><a href="<?= site_url('login/getstarted');?>">Login</a></li>
                        </ul>
                    </div>
                </div> 
            </nav> 
