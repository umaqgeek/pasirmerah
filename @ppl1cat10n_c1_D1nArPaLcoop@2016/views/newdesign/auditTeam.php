        ...
        <section id="partners">
            <div class="container">
                <div class="section-header">
                    <BR><BR>
                    <h2 class="section-title text-center wow fadeInDown">Internal Audit Team</h2>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="media service-box wow fadeInRight">
                            ...
                            <div class="media-body">
                                ...
                                <p class="text-justify wow FadeInDown">Encik Abdul Rahman Bin Taiyun</p>
                            </div>
                        </div>
            ...
            <div class="container">
                ...
                <div class="col-sm-6">
                    <div class="media service-box wow fadeInRight">
                        ...
                        <div class="media-body">
                            <h4 class="media-heading">Committee member</h4>
                            <p class="text-justify wow FadeInDown">
                                Puan Siti Hajar Binti Sharif
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="media service-box wow fadeInRight">
                            ...
                            <div class="media-body">
                                <h4 class="media-heading">Committee member</h4>
                                <p class="text-justify wow FadeInDown">
                                    Raja Puteri Shafiqkin Binti Raja Mokhtar
                                </p>
                            </div>
                        </div>
