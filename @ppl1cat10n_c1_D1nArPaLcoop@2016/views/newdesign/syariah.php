        ...
        <section id="partners">
            <div class="container">
                <div class="section-header">
                    <BR><BR>
                    <h2 class="section-title text-center wow fadeInDown">Syariah Council Member</h2>
                ...
                <div class="row">
                    <div class="col-sm-6 wow fadeInLeft">
                        <img class="img-responsive" src="<?php echo base_url(); ?>assets/imagescoop/client2.png"  height="400px" width="400px"  alt="">
                    </div>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="media service-box wow fadeInRight">
                            ...
                            <div class="media-body">
                                ...
                                <p class="text-justify wow FadeInDown">Mohd Mirza Bin Hj Abdul Rashid</p>
                            </div>
                        </div>
            ...
            <div class="container">
                ...
                <div class="col-sm-6">
                    <div class="media service-box wow fadeInRight">
                        ...
                        <div class="media-body">
                            <h4 class="media-heading">Councillor</h4>
                            <p class="text-justify wow FadeInDown">Prof Dr. Shahrin Bin Sahib</p>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="media service-box wow fadeInRight">
                            ...
                            <div class="media-body">
                                <h4 class="media-heading">Councillor</h4>
                                <p class="text-justify wow FadeInDown">Dr. Mohd Rizal Bin Abdul Razak</p>
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="media service-box wow fadeInRight">
                            ...
                            <div class="media-body">
                                <h4 class="media-heading">Councillor</h4>
                                <p class="text-justify wow FadeInDown">Mohd Adli Bin Ithnin</p>
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="media service-box wow fadeInRight">
                            ...
                            <div class="media-body">
                                <h4 class="media-heading">Councillor</h4>
                                <p class="text-justify wow FadeInDown">Khairil Azhar Bin Hariri</p>
                            </div>
                        </div>
