        ...
        <section id="features">
            <div class="container">
                <div class="section-header">
                    <h2 class="section-title text-center wow fadeInDown">Partner Links</h2>
                </div>
                <div class="col-md-3 col-md-offset-3">
                    <a href="http://www.hargaemas.com.my/" target="_blank">
                        <img class="img-responsive wow fadeIn" src="<?php echo base_url(); ?>assets/imagess/partners/hargaemas.png" alt="" data-wow-duration="300ms" data-wow-delay="300ms">
                        
                    </a>
                    <p>Hargaemas Trading</p>
                  </div>  
                    <div class="col-md-6">
                    <a href="http://www.perfumeheaven.my/" target="_blank">
                        <img class="img-responsive wow fadeIn" src="<?php echo base_url(); ?>assets/imagess/partners/perfume.png" alt="" data-wow-duration="300ms" data-wow-delay="300ms" style="width: 45%;">
