    ...
    <body id="home" class="homepage">
            ...
            <nav id="nb2sb-nav" class="navbar navbar-default navbar-fixed-top">
                <div class="container">
                    <div class="navbar-header" >
                        <a class="navbar-brand" href="<?php echo site_url('version3') ?>"> <img src="<?php echo base_url(); ?>assets/imagescoop/images5.png" width="150" alt="logo" style="margin-top:-6px;"></a>
                    ...
                    <div id="nb2sb-content" class="collapse navbar-collapse navbar-right">
                        <ul class="nav navbar-nav" style="margin-top:5px;" >
                            ...
                            <li class="scroll"><a href="http://dinarpal.com" style="text-decoration: none" target="_blank">About</a></li>
        ...
        <section id="partners">
            <div class="container">
                <div class="section-header">
                    <BR><BR>
                    <h2 class="section-title text-center wow fadeInDown">Board Of Co-Operative</h2>
                    <p class="text-center wow fadeInDown">We are deeply grateful for the generosity of our funders, partners and sponsors who support key initiatives that move DinarPal forward. May Allah bless all of you</p>
                </div>


                <div class="row">
                    <div class="col-sm-6 wow fadeInLeft">
                        <img class="img-responsive" src="<?php echo base_url(); ?>assets/imagess/document/Lesen MPHTJ-page-001.jpg"  height="400px" width="400px"  alt="">
                    </div>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="media service-box wow fadeInRight">
                            ...
                            <div class="media-body">
                                <h4 class="media-heading">Local Authority Premise License</h4>
                                <p class="text-justify wow FadeInDown">An approval from Hang Tuah Jaya, City Council of Melaka, Malaysia to operate pawn business at the respective premise</p>
                            </div>
                        </div>
            ...
            <div class="container">
                ...
                <div class="col-sm-6">
                    <div class="media service-box wow fadeInRight">
                        ...
                        <div class="media-body">
                            <h4 class="media-heading">Syariah Compliances</h4>
                            <p class="text-justify wow FadeInDown">

                                An approval of Syariah compliances issued by internel syariah committee of Al-DinarPal Group as adviced by Department of Islamic Development Malaysia (JAKIM)
                            </p>
                        </div>
                    </div>
                ...
                <div class="col-sm-6 wow fadeInLeft">
                    <img class="img-responsive" src="<?php echo base_url(); ?>assets/imagess/document/Pengesahan Kepatuhan Syariah PSB.jpg"   height="400px" width="400px"  alt="">
                </div>		
        ...
        <section id="partners">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-6 wow fadeInLeft">
                        <img class="img-responsive" src="<?php echo base_url(); ?>assets/imagess/document/Sijil Angkasa-page-001.jpg"  height="400px" width="400px"  alt="">
                    </div>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="media service-box wow fadeInRight">
                            ...
                            <div class="media-body">
                                <h4 class="media-heading">National Cooperative Membership</h4>
                                <p class="text-justify wow FadeInDown">

                                    Certificate of membersip with National Cooperative Organisation of Malaysia Berhad (ANGKASA)
                                </p>
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="media service-box wow fadeInRight">
                            ...
                            <div class="media-body">
                                <h4 class="media-heading">Ar-Rahnu Approval</h4>
                                <p class="text-justify wow FadeInDown">
                                    Ar-Rahnu approval form Cooperative Commission of Malaysia (SKM)
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-6 wow fadeInLeft">
                        <img class="img-responsive" src="<?php echo base_url(); ?>assets/imagess/document/Surat Kelulusan SKM Ar-Rahnu DinarPal-page-001.jpg"   height="400px" width="400px"  alt="">
                    </div>
        ...
        <section id="partners">
            <div class="container">
                <div class="row">
                    <div class="col-sm-6 wow fadeInLeft">
                        <img class="img-responsive" src="<?php echo base_url(); ?>assets/imagess/document/Surat Kelulusan SKM membuka cawangan DinarPal-page-001.jpg"  height="400px" width="400px"  alt="">
                    </div>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="media service-box wow fadeInRight">
                            ...
                            <div class="media-body">
                                <h4 class="media-heading">Ar-Rahnu Approval</h4>
                                <p class="text-justify wow FadeInDown">Ar-Rahnu approval form Cooperative Commission of Malaysia (SKM)</p>
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="media service-box wow fadeInRight">
                            ...
                            <div class="media-body">
                                <h4 class="media-heading">DinarPal Cooperative Approval</h4>
                                <p class="text-justify wow FadeInDown">
                                    Certificate of registration of Koperasi DinarPal Melaka Berhad from (SKM)
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-6 wow fadeInLeft">
                        <img class="img-responsive" src="<?php echo base_url(); ?>assets/imagess/document/Perakuan Pendaftaran Koperasi.jpg"   height="400px" width="400px"  alt="">
                    </div>
