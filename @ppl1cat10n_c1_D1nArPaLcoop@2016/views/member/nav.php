            ...
            <li>
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu" role="menu" style="margin-top: 12px">
                        ...
                        <li><a href="<?= site_url('staff/newMenu/vault/015') ?>" style="color:#FFF;">Payment</a></li>
                        <li><a href="<?= site_url('staff/newMenu/transaction/09') ?>" style="color:#FFF;">Share</a></li>
                        <li><a href="<?= site_url('staff/transactions/transSum1/y51') ?>" style="color:#FFF;">Document</a></li>
                    </ul>
