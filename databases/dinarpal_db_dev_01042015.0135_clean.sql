...
--
-- Host: localhost
-- Generation Time: Apr 01, 2015 at 01:35 AM
...
('734ccaf59b32b0f989a276afb6cf5674', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.2; WOW64) AppleWebKit/53', 1427822698, ''),
...
(1, 1, '0', '0', '1000', '0', '0', '0', '1000', '0', '0'),
(7, 7, '0', '0', '1000', '0', '0', '0', '1000', '0', '0'),
...
CREATE TABLE IF NOT EXISTS `dinarpal_admin_account` (
  ...
  `daa_account` varchar(200) NOT NULL DEFAULT '0',
  PRIMARY KEY (`daa_id`)
...
INSERT INTO `dinarpal_admin_account` (`daa_id`, `daa_account`) VALUES
(1, '199000');
