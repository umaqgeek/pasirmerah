...
--
-- Host: localhost
-- Generation Time: Feb 03, 2016 at 01:32 PM
...
('5f9f7a354f25ddcc2041382d5a9cf825', '0.0.0.0', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_5) Ap', 1454502732, ''),
...
(1, 1, '167.75', '27796.1542', '176786.08301', '85', '0', '0', '200000', '0', '0'),
...
--
ALTER TABLE `pawn_child_child`
  MODIFY `pcc_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=22;
--
...
--
ALTER TABLE `transaction`
  MODIFY `tr_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=19;
--
