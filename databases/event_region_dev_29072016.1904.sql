...
CREATE TABLE IF NOT EXISTS `event_region` (
  `er_id` int(11) NOT NULL,
  `er_name` varchar(200) NOT NULL
...
--
-- Indexes for table `event_region`
--
ALTER TABLE `event_region`
...
--
-- AUTO_INCREMENT for table `event_region`
--
ALTER TABLE `event_region`
