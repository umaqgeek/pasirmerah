...
--
-- Host: localhost
-- Generation Time: Oct 08, 2015 at 09:10 AM
...
CREATE TABLE IF NOT EXISTS `button_api` (
  ...
  `baa_id` int(11) DEFAULT NULL,
  `bap_price` varchar(20) DEFAULT NULL,
  `bap_qty` int(11) DEFAULT NULL,
  `bap_subscription_period` varchar(20) DEFAULT NULL,
  `bap_trial_period` varchar(20) DEFAULT NULL,
  `bap_setup_fee` varchar(200) DEFAULT NULL,
  `bap_tax` varchar(200) DEFAULT NULL,
  `bap_shipping` varchar(200) DEFAULT NULL,
  `bap_return_url` varchar(200) DEFAULT NULL,
  `bap_notify_url` varchar(200) DEFAULT NULL,
  `bap_cancel_url` varchar(200) DEFAULT NULL,
  `bap_comments` varchar(200) DEFAULT NULL,
...
('6691d15b39a0282b3bdad2f2bc2ef07d', '0.0.0.0', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_5) Ap', 1444288249, ''),
...
(17, '6d3ac-adeq-nur---ftmk!-20150212_151603.jpg', 'Nur Umira', 'Mustafa', 'nur', '$2a$08$R26OP4OtJ2PCewXZLW5ab.DpVPpHZwRtR.Fbfm4qKXTothzh7KkG6', 'What is my username?', 'nur', 'b55178b011bfb206965f2638d0f87047', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'nurumira@gmail.com', '2015-04-27 03:12:49', 1, 2, '2015-09-03T17:14:18+02:00', '69c0e639c71a34bb6b710f043138f7f8', 3, 1),
